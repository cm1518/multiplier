...
do_fullins = 1;             % set this to 1 to solve with perfect risk-sharing
do_constantelast = 0;       % set this to 1 to solve model with constant wage elasticity
...
table4_entries=temp(:);
results_main_dsge_pi=table4_entries';

save results_main_pi results_main_dsge_pi
