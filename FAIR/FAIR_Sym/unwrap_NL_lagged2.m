function [ Sigma] = unwrap_NL_lagged2(  beta_gen_neg,b_gen_neg,c_gen_neg,epsilon_vec,setup )
...
for jj=1:setup.lags
   ...
   Sigma(:,setup.index_unrestricted,jj+1)=sum(SL_NL_3(beta_gen_neg(:,:),b_gen_neg(:,:),c_gen_neg(:,:),jj),2);
