...
results_asym_state_47.med=prctile(Msum,50,3);
results_asym_state_47.lower=prctile(Msum,5,3);
results_asym_state_47.upper=prctile(Msum,95,3);
...
results_asym_state_47.prob_pos=num2str(count/length(Msum));
...
disp(' ')
results_asym_state_47.prob_neg=num2str(count/length(Msum));

save asym_state_results_for_table_47 results_asym_state_47
