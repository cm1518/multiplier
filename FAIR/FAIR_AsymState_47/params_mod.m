...
mod_params.r_neg=params(counter:counter+setup.size_obs-setup.index_unrestricted);
...
mod_params.r_pos=params(counter:counter+setup.size_obs-setup.index_unrestricted);
counter=counter+setup.size_obs-setup.index_unrestricted+1;
