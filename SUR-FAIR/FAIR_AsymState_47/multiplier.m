...
results_asym_state_sur_47.med=prctile(Msum,50);
results_asym_state_sur_47.lower=prctile(Msum,5);
results_asym_state_sur_47.upper=prctile(Msum,95);
...
results_asym_state_sur_47.prob_pos=num2str(count/length(Msum));
...
results_asym_state_sur_47.prob_neg=num2str(count/length(Msum));

save asym_state_results_for_table_sur_47 results_asym_state_sur_47
