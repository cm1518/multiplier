function varargout=shadedErrorBar_RB(x,y,errBar,lineProps,transparent,shadeindex)
...
%   RB: shadeindex - ==2 to make the band lighter than usual
%
% Outputs
...
% %RB: add shadeindex if it was not entered
% if isempty(shadeindex)==1
%     shapeindex=1;
% end
...
patchSaturation=0.15*shadeindex; %How de-saturated or transparent to make patch
if transparent
